    ...
    let visual_source = VisualSource {
        root_objects: vec![
            ...
            Block::new(
                ...
                None,
                vec![
                    BlockInput::new("Function", BlockInputVisibility::Implicit, vs_str!("foo")),
                    BlockInput::new("Parameters", BlockInputVisibility::Implicit, vs_tuple!["TUPLEPARAM_Parameters_1", "TUPLEPARAM_Parameters_2"]),
                    BlockInput::new("TUPLEPARAM_Parameters_1", BlockInputVisibility::Explicit, vs_str!("param1")),
                    BlockInput::new("TUPLEPARAM_Parameters_2", BlockInputVisibility::Explicit, vs_num!(2))
                ],
                vec![
                    BlockOutput::new("ReturnedValues", vec!["bar1".into(), "bar2".into()])
                ]
            ),
        ]
    };
